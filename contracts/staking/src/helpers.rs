...
// Basic test - based on figures from excalidraw
    ...
    fn test_compute_mint_amount() {
        ...
        let mint_amount = compute_mint_amount(total_native_token, total_liquid_stake_token, native_to_stake);
    ...
    fn test_compute_unbond_amount() {
        ...
        let unbond_amount = compute_unbond_amount(total_native_token, total_liquid_stake_token, batch_unstake);
