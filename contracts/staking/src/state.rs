...
use cosmwasm_std::{Addr, DepsMut, Env, StdError, Timestamp, Uint128};
...
impl ProtocolChainConfig {
    /// Gets the denom of the LST token generated by the
    /// x/tokenfactory module.
    pub fn lst_token_factory_denom(&self, env: Env) -> String {
        format!(
            "factory/{0}/{1}",
            env.contract.address, self.liquid_stake_token_denom,
        )
    }
}
