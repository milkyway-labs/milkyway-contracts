...
# this is the pool creation fee
osmosisd tx bank send validator1 $OSMOSIS_ADDR 1000000000uosmo --keyring-backend=test --home=$HOME/.osmosisd/validator1 --chain-id osmosis-dev-1 --fees 875stake -y --broadcast-mode block

CELESTIA_ADDR=celestia1sfhy3emrgp26wnzuu64p06kpkxd9phel74e0yx
celestia-appd tx bank send validator1 $CELESTIA_ADDR 500000000utia --keyring-backend=test --home=$HOME/.celestia-app/validator1 --node http://0.0.0.0:26661  --chain-id celestia-dev-1 --fees 21000utia -y --broadcast-mode block
