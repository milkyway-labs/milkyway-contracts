...
INIT={\"native_token_denom\":\"osmoTIA\",\"liquid_stake_token_denom\":\"mlk\",\"treasury_address\":\"$OSMOSIS_VALIDATOR_1\",\"node_operators\":[\"$OSMOSIS_VALIDATOR_1\",\"$OSMOSIS_VALIDATOR_2\",\"$OSMOSIS_VALIDATOR_3\"],\"validators\":[\"$CELESTIA_VALIDATOR_1\"],\"batch_period\":86400,\"unbonding_period\":1209600,\"protocol_fee_config\":{\"dao_treasury_fee\":\"10\"},\"multisig_address_config\":{\"controller_address\":\"$OSMOSIS_VALIDATOR_1\",\"staker_address\":\"$OSMOSIS_VALIDATOR_1\",\"reward_collector_address\":\"$OSMOSIS_VALIDATOR_1\"},\"minimum_liquid_stake_amount\":\"100\",\"minimum_rewards_to_collect\":\"10\"}
